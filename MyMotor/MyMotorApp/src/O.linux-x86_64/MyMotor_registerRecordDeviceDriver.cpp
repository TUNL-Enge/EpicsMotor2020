...
/* Generated from ../O.Common/MyMotor.dbd */
...
static const char * const recordTypeNames[] = {
    ...
    "mbboDirect", "motor", "permissive", "printf", "sel", "seq", "state",
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devaaiStream,
    ...
    *pvar_dset_devMCB4B, *pvar_dset_devPrintfSoft,
    ...
    *pvar_dset_asynFloat64TimeSeries, *pvar_dset_devXxxSoft;
...
static const char * const deviceSupportNames[] = {
    ...
    "devMbbiSoftRaw", "devMbbiSoftCallback", "devmbbiStream",
    ...
    "devmbboDirectStream", "asynMbboDirectUInt32Digital", "devMotorAsyn",
    "devMCB4B", "devPrintfSoft", "devPrintfSoftCallback",
...
epicsShareExtern drvet *pvar_drvet_drvAsyn, *pvar_drvet_drvMCB4B,
    *pvar_drvet_stream;

static const char *driverSupportNames[] = {
    "drvAsyn", "drvMCB4B", "stream"};
...
epicsShareExtern reg_func pvar_func_AcsRegister,
    pvar_func_AsynDriverInterfaceRegistrar, pvar_func_MCB4BRegister,
    ...
    pvar_func_initTraceRegister, pvar_func_motorRegister,
    pvar_func_motorUtilRegister, pvar_func_streamRegistrar,
...
int MyMotor_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/enge/project/IOCs/MyMotor";
...
/* MyMotor_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"MyMotor_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    MyMotor_registerRecordDeviceDriver(*iocshPpdbbase);
}
